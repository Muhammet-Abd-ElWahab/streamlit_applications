...
# This is a function to clean the data (We will include all cleaning steps inside this function)
def clean_data(dataframe):
    df = dataframe.copy()
#     survival_mapping = {
#     "Survived on 5 years or more": 1,
#     "Deceased within 5 years": 0
# }
    df.chemotherapy_type = df.chemotherapy_type.fillna("no_chemotherapy")                
    df.radiotherapy_type = df.radiotherapy_type.fillna("no_radiotherapy") 
    mappings = {
    "er_status": {
        "Positive": 2,
        "Negative": 0,
...
full_df = pd.read_csv('./Data/breast_cancer_dataset.csv')
full_df.chemotherapy_type = full_df.chemotherapy_type.fillna("no_chemotherapy")                
full_df.radiotherapy_type = full_df.radiotherapy_type.fillna("no_radiotherapy") 
